...
public class БібліотекаЛент(IJSRuntime jsСередаВиконання)
{
    ...
    public async Task ДодатиЛенту(string назва, string шаблонДизайну, string зміст)
    {
        ...
        ленти.Add(new (назва, шаблонДизайну, зміст));
    ...
    public async Task ЗамінитиЛенту(string назва, string шаблонДизайну, string зміст)
    {
        var існуючаЛента = ленти.FirstOrDefault(_ => _.Назва == назва);
        if (існуючаЛента is not null)
        {
